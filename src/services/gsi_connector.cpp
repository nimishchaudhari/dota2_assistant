...
// Fix for Windows header conflicts
#define WIN32_LEAN_AND_MEAN
#include <Windows.h>

// Include our simplified httplib instead of the full library
// to avoid OpenSSL dependency issues
...
std::chrono::milliseconds GSIConnector::calculateBackoffDelay() const {
    ...
    int backoffSeconds = std::min<int>(30, (1 << reconnectAttempts_));
